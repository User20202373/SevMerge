...
-- 2번 슬롯: 메인 화면 중간 배너 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('메인 미들 배너', 'MIDDLE_BANNER', 5000, NOW(), DATE_ADD(NOW(), INTERVAL 30 MINUTE), 'OPEN', NOW());

-- 3번 슬롯: 프로젝트 리스트 최상단 프리미엄 노출 구역 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('프로젝트 리스트 상단', 'LIST_TOP', 15000, NOW(), DATE_ADD(NOW(), INTERVAL 1 HOUR), 'OPEN', NOW());

-- 4번 슬롯: 전문가 리스트 최상단 프리미엄 노출 구역 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('전문가 리스트 상단', 'EXPERT_TOP', 12000, NOW(), DATE_ADD(NOW(), INTERVAL 2 HOUR), 'OPEN', NOW());

-- 5번 슬롯: 커뮤니티 우측 사이드바 고정 광고 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('커뮤니티 우측 사이드바', 'SIDEBAR', 3000, NOW(), DATE_ADD(NOW(), INTERVAL 12 HOUR), 'OPEN', NOW());

-- 6번 슬롯: 로그인 완료 후 팝업 광고 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('로그인 레이어 팝업', 'POPUP', 8000, NOW(), DATE_ADD(NOW(), INTERVAL 24 HOUR), 'OPEN', NOW());

-- 7번 슬롯: 모바일 앱 메인 띠배너 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('모바일 앱 하단 띠배너', 'APP_LINE_BANNER', 4000, NOW(), DATE_ADD(NOW(), INTERVAL 45 MINUTE), 'OPEN', NOW());

-- 8번 슬롯: 마감 직전 프로젝트 리스트 강조 구역 (CLOSED - 입찰 종료 연출)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('마감 임박 리스트 강조', 'DEADLINE_TOP', 6000, DATE_ADD(NOW(), INTERVAL -2 HOUR), DATE_ADD(NOW(), INTERVAL -10 MINUTE), 'CLOSED', NOW());

-- 9번 슬롯: 마이페이지 하단 추천 전문가 배너 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('마이페이지 추천 배너', 'MYPAGE_BANNER', 2000, NOW(), DATE_ADD(NOW(), INTERVAL 3 HOUR), 'OPEN', NOW());

-- 10번 슬롯: 메인 배너 2번 구역 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('메인 배너 2호 슬롯', 'MAIN_BANNER', 10000, NOW(), DATE_ADD(NOW(), INTERVAL 15 MINUTE), 'OPEN', NOW());

-- 11번 슬롯: 뉴스레터 이메일 상단 광고 지면 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('이메일 뉴스레터 상단', 'NEWSLETTER_TOP', 7000, NOW(), DATE_ADD(NOW(), INTERVAL 6 HOUR), 'OPEN', NOW());

-- 12번 슬롯: 검색 결과 페이지 추천 키워드 상단 (CLOSED - 입찰 종료 연출)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('검색 태그 상단 강조', 'SEARCH_TOP', 5000, DATE_ADD(NOW(), INTERVAL -1 HOUR), DATE_ADD(NOW(), INTERVAL -5 MINUTE), 'CLOSED', NOW());

-- 13번 슬롯: 프로젝트 등록 완료 페이지 하단 광고 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('등록 완료 페이지 하단', 'REG_FINISH_BANNER', 3500, NOW(), DATE_ADD(NOW(), INTERVAL 4 HOUR), 'OPEN', NOW());

-- 14번 슬롯: 모바일 앱 푸시 알림 연동 광고 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('스폰서 푸시 알림 슬롯', 'PUSH_AD', 20000, NOW(), DATE_ADD(NOW(), INTERVAL 30 MINUTE), 'OPEN', NOW());

-- 15번 슬롯: 자유게시판 글 본문 중간 네이티브 광고 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('게시판 본문 내 광고', 'BOARD_INLINE', 4500, NOW(), DATE_ADD(NOW(), INTERVAL 90 MINUTE), 'OPEN', NOW());

-- 16번 슬롯: 챗봇 상담 창 하단 미니 링커 배너 (OPEN)
INSERT INTO ad_slot_tb (slot_name, slot_type, min_bid_price, bid_start_at, bid_end_at, status, created_at)
VALUES ('챗봇 하단 미니 광고', 'CHATBOT_BANNER', 2500, NOW(), DATE_ADD(NOW(), INTERVAL 5 HOUR), 'OPEN', NOW());
